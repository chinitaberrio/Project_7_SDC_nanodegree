...
For doing this project and creating smooth trajectories I used http://kluge.in-chemnitz.de/opensource/spline/, the spline function is in a single hearder file is really easy to use.
