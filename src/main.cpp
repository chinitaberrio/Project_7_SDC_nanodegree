    ...
    if (length && length > 2 && data[0] == '4' && data[1] == '2') {
      ...
      if (s != "") {
        ...
        if (event == "telemetry") {
          ...
          //creating widely spaced (x,y) waypoints, spaced at 30 m
          vector<double> ptsx;
          vector<double> ptsy;
          ...
          if (prev_size < 2) {
            ...
            // Use thwo points that make the path tangent to the previos path
          ...
          for (int i =0; i<= 50-previous_path_x.size(); i++) {
            ...
            double N = target_dist/(.02*ref_vel/2.24); // meter/second
            ...
            // rotate back to normal after rotating it earlier // to global coordinates
